...
const HeroSection = () => {
  return (
    <section className="relative min-h-[500px] bg-gradient-to-br from-gray-900 via-slate-800 to-gray-900 flex items-center justify-center overflow-hidden mt-13">
